...
<tbody>
  @foreach ($pendaftarans as $pendaftaran)
    <tr>
      ...
      <td>
        <a href="/pendaftaran/{{ $pendaftaran->id }}" class="badge bg-info"><i class="bi bi-eye"> View More</i></a>
        <a href="/pendaftaran/{{ $pendaftaran->id }}/edit" class="badge bg-warning"><i class="bi bi-pencil-square"> Edit</i></a>
